...
# Config ------------------------------------------------------------------
# Data type
datatype <- "Poisson_Bernoulli"
# Number of node.
p <- 20
# Ratio of Bernoulli:Poisson
ratio <- 0.5
...
# Number of Bernoulli nodes
p2 <- floor(p * ratio)

# Number of Poisson nodes
p1 <- p - p2
...
source(file.path(file_path, "Data_type_specific", "poisson_bernoulli.R"))
